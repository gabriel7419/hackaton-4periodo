...
class ReservaController extends Controller
{
    ...
    public function destroy(Reserva $reserva)
    {
        ...
        /**
 * Exibe o histórico de reservas do usuário autenticado.
 */
// public function historico(Request $request)
// {
//     $userId = $request->user()->id; // ID do usuário autenticado

//     $reservas = Reserva::where('user_id', $userId)
//         ->orderBy('data_reserva', 'desc')
//         ->orderBy('hora_inicio', 'desc')
//         ->with('ambiente') // Carrega o relacionamento com o ambiente
//         ->get();
...
public function historico(Request $request)
{
    // Pega todas as reservas, sem necessidade de autenticação
    $reservas = Reserva::orderBy('data_reserva', 'desc')
        ->orderBy('hora_inicio', 'desc')
        ->with('ambiente') // Carrega o relacionamento com o ambiente
        ->get();
